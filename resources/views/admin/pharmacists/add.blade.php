...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="{{route('addPharmacist')}}" method="POST">
                @csrf 
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" name="pharmacy_name">
              </div>
              <div class="form-group">
                <label for="inputName">Pharmacy Address </label>
                <input type="text" id="inputName" class="form-control" name="pharmacy_address">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
      ...
      <div class="row">
        <div class="col-12">
          <input type="submit" value="Add new pharamacist" class="btn btn-success">
        </div>
      </div>
    </form>
    </section>
